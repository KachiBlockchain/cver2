...
const Footer = () => {
  return (
    ...
    >
        ...
        <div className="flex flex-col lg:mt-12 lg:flex-row lg:justify-evenly justify-center gap-x-8 ">
          ...
          <div className="flex  container mx-auto  flex-col lg:flex-row black-footer-text lg:justify-between gap-x-32 lg:mt-0">
            <div className="flex flex-col gap-y-4">
              <h1 className="text-black text-[20px]  font-semibold mt-8">Company</h1>
              <p className="text-black">Services</p>
              <p className="text-black">Templates</p>
              <p className="text-black">Pricing</p>
            </div>
            <div className="flex flex-col gap-y-4">
              <h1 className="text-black text-[20px]  font-semibold mt-8">Support</h1>
              <p>How it works</p>
              <p>FAQs</p>
            </div>
            <div className="flex flex-col gap-y-4">
              <h1 className="text-black text-[20px] font-semibold mt-8">Contact Us</h1>
                ...
                {social.map((item, index) => {
                  ...
                  return (
                    <div className="border-2 border-blue-800 w-8 h-8 lg:w-8 lg:h-8 rounded-full justify-center items-center flex">
                      <a
                        className="text-blue-600 lg:text-[14px]"
                        href={href}
                        key={index}
                      >
                        {icon}
      ...
      <div className="flex mt-2 border-t-2 border-blue-200 ">
        <div className="lg:ml-16 container mx-auto  flex flex-col lg:flex-row  text-black text-[14px]  gap-x-4  ">
