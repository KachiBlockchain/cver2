...
const FAQ = () => {
  return (
    <div className="flex flex-col items-center justify-center my-16">
      <h1 className="text-[30px] flex justify-start leading-[44px] text-black md:text-[60px] md:leading-tight lg:text-[40px] lg:leading-[1.2] text-center  font-bold md:tracking-[-2px]">
        Frequently Asked Questions
      </h1>
      <p className="text-black max-w-[480px] text-[14px] text-center lg:text-left mt-4 lg:leading-[1.2]">
