      ...
      <div className="flex flex-col items-center justify-evenly gap-x-8 lg:flex-row px-8">
        ...
        <div className="order-1 lg:order-2 my-16">
          ...
          <div
            data-aos="fade-right"
            data-aos-duration="2000"
            className="flex flex-1  flex-col justify-start items-start lg:justify-center"
          >
            <h1 className="text-[40px] flex justify-start text-center leading-[44px] text-black md:text-[60px] md:leading-tight lg:text-[40px] lg:leading-[1.2] font-bold md:tracking-[-2px]">
              Tailored CV
            </h1>

            <p className="max-w-[500px] text-[20px] mt-4 text-black">
            ...
            <Link to="/login">
              <button className="btn mt-8 self-start btn-md bg-blue-800 rounded-[10px] hover:bg-blue-400 md:btn-lg transition-all ">
      ...
      <div className="flex flex-col items-center justify-evenly mt-32 gap-x-8 lg:flex-row px-8 my-16">
        <div>
          ...
          <div
            data-aos="fade-right"
            data-aos-duration="2000"
            className="flex flex-1 flex-col my-8 justify-start items-start lg:order-1 order-2 lg:justify-center"
          >
            <h1 className="text-[40px] flex justify-start text-center leading-[44px] text-black md:text-[60px] md:leading-tight lg:text-[40px] lg:leading-[1.2] font-bold md:tracking-[-2px]">
        ...
        <div className="flex items-center drop-shadow-2xl z-10 ">
          <div
            data-aos="zoom-in"
            data-aos-duration="2000"
            className="bg-white lg:ml-20 lg:order-2 order-1 items-center lg:-mb-16 w-[400px] lg:w-[490px] rounded-xl h-[280.786px] pt-10 pl-16 text-black p-4 relative justify-center mb-16"
          >
            <p className="max-w-[300px] font-bold ">Experience</p>
            <p className="max-w-[300px] ">
      ...
      <div className="flex flex-col justify-evenly mt-32 gap-x-8 lg:flex-row px-8 my-16">
        <div className="flex items-center drop-shadow-2xl z-10 ">
          <div
            ...
            className="bg-white lg:ml-20  items-center lg:-mb-16 w-[400px] lg:w-[490px] rounded-xl h-[280.786px] pt-10 pl-16 text-black p-4 relative justify-center mb-16"
          >
            <p className="max-w-[300px] font-bold ">Interview Questions</p>
            <p className="max-w-[300px] ">
