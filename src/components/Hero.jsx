    ...
    >
      <div className="container mx-auto h-full">
        <div className="flex flex-col lg:my-0 lg:flex-row justify-evenly items-start h-full pt-32">
          ...
          >
            <h1 className="text-[30px] mb-4 flex justify-start text-start leading-[44px] text-black md:text-[60px] md:leading-tight lg:text-[40px] lg:leading-[1.2] font-bold md:tracking-[-2px] heroheading">
            ...
            <div className="items-center flex md:hidden justify-center">
              <img
            ...
            <input
              ...
              type="text"
            /> */}
            <label className="text-black font-bold text-[20px] text-start pt-[50px] items-start ">
              Job Description
            </label>
          ...
          <div
            ...
            data-aos-duration="2000"
            data-aos-delay="900"
            className="flex order-1 my-8 lg:mt-0 flex-col lg:flex-row  h-full"
          >
