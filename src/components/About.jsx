    ...
    >
      <div className="flex flex-col lg:flex-row container mx-auto justify-evenly ">
        ...
        <div
          ...
          data-aos-delay="900"
          className="flex flex-col mt-8 items-center lg:items-start mb-16"
        >
          ...
          <div className="flex gap-x-4">
            <img src={paste} alt="" />
            <p className="text-black mt-4 max-w-[480px] text-[24px] text-center lg:text-left lg:leading-[1.2]">
              Paste Your Job
            </p>
          </div>
        ...
        >
          ...
          <Link to="/login">
            <button className="btn items-center justify-center btn-md bg-blue-800 rounded-[10px] hover:bg-blue-400 md:btn-lg transition-all ">
